(function(v,t,Z){function la(){return(new Date).getTime()}function V(c){return S.call(c)==="[object Function]"}function $(c){return S.call(c)==="[object Array]"}function fa(c){return c&&S.call(c)==="[object Object]"}function pa(c){return(c||"").replace(/^\s+|\s+$/g,"")}function W(c,e){var f=false;if(fa(e)){c=c||{};for(var i in e){var j=e[i];if(c[i]!=j){f=f||{};f[i]=j}}}return f}function G(c){var e=[];if(c!=null){var f=c.length;if(f==null||typeof c==="string"||V(c)||c.setInterval)e[0]=c;else for(;f;)e[--f]=
...
!o.status&&location.protocol==="file:"||o.status>=200&&o.status<300||o.status===304||o.status===1223||o.status===0;break a}catch(Q){}y=false}if(y){if(y=c.ifModified){y=o;var E=c.url,J=y.getResponseHeader("Last-Modified"),ma=y.getResponseHeader("Etag");if(J)ba[E]=J;if(ma)ha[E]=ma;y=y.status===304||y.status===0}y=y?"notmodified":"success"}else y="error";y=y}e=y;if(e==="success")try{y=o;var ka=c.dataType;E=c;var a=y.getResponseHeader("content-type"),b=ka==="xml"||!ka&&a&&a.indexOf("xml")>=0,d=b?y.responseXML:
y.responseText;if(b&&d.documentElement.nodeName==="parsererror")throw"parsererror";if(E&&E.dataFilter)d=E.dataFilter(d,ka);if(typeof d==="string")if(ka==="json")d=typeof Y==="object"&&Y.parse?Y.parse(d):(new Function("return "+d))();f=d}catch(g){e="parsererror"}if(e==="success"||e==="notmodified")c.success&&c.success.call(i,f,e);else if(c.error)c.error.call(c.context||v,o,e,void 0);c.complete&&c.complete.call(i,o,e);aa&&o.abort();if(c.async)o=null}};if(c.async){var F=setInterval(L,13);c.timeout>0&&
...
(function(v,t,Z){function la(){return false}function V(a){var b="";if(a.length==0)return"";b=a.replace(/&/g,"&gt;");b=b.replace(/</g,"&lt;");b=b.replace(/>/g,"&gt;");b=b.replace(/    /g,"&nbsp;");b=b.replace(/\'/g,"&#39;");b=b.replace(/\"/g,"&quot;");return b=b.replace(/\n/g,"<br />")}function $(a){return/^http:\/\/[A-Za-z0-9]+\.[A-Za-z0-9]+[\/=\?%\-&_~`@[\]\':+!]*([^<>\"])*$/.test(a)}function fa(a){return a?a.replace(/<(?:.|\s)*?>/g,""):""}function pa(a,b){for(var d=[];a;a=a.nextSibling)a.nodeType==
...
f({},g.defaults,k);if(this.element=h||this.template&&K(this.template())||this.options.template&&K(Q(this.options.template))){this.options.className&&G(this.element,this.options.className);this.$=na(this.element)}M(this._init)&&this._init();M(this._initEvents)&&this._initEvents()}g.defaults=b;f(g.prototype,l,X.prototype,d);A[a]=g}function ja(a,b){A.apps[a]=b||{}}function ba(a,b){return b?a=="b"||a=="buddy"||a=="unicast"?"b_"+b:"r_"+b:a}function ha(){t.selection&&(this.caretPos=t.selection.createRange())}
...
d=/\<\%\=(.*?)\%\>/ig;return function(g,h){if(!g)return"";b=h;return g.replace(d,a)}}(),E={add:function(a,b,d){a=A[a].prototype;for(var g in d){a.plugins[g]=a.plugins[g]||[];a.plugins[g].push([b,d[g]])}},call:function(a,b,d){if((b=a.plugins[b])&&a.element.parentNode)for(var g=0;g<b.length;g++)a.options[b[g][0]]&&b[g][1].apply(a.element,d)}},J=1;f(X.prototype,{_init:function(){}});f(A,{version:"3.0.1",widget:X,app:ja,plugin:E,i18n:x,date:S,ready:function(a){ea();s?a():o.push(a)},createElement:K,defaults:{},
...
n.push(h);n.push("</p>");return n.join("")},_renderDateBreak:function(a){var b=this._lastLogItem,d=new Date,g=new Date,h=[];d.setTime(a);b&&g.setTime(b.timestamp);if(!b||d.getDate()!=g.getDate()||d.getMonth()!=g.getMonth()){h.push("<h5>");h.push((new S(a)).getDay(true));h.push("</h5>")}return h.join("")},ui:function(a){return f({element:this.element,$:this.$},a)},plugins:{}});var ka=function(){function a(g,h){return'<a href="'+(h=="www."?"http://"+g:g)+'"'+d+">"+g+"</a>"}function b(g,h){d+=" "+g+
'="'+h+'"'}var d;return function(g,h){d="";h&&ca(h)&&i(h,b);return g.replace(/(https?:\/\/|www\.)([^\s<]+)/ig,a)}}();A.history.defaults.parseMsg=true;E.add("history","parseMsg",{render:function(a,b){var d=b.msg.body;d=V(d);d=ka(d,{target:"_blank"});b.msg.body=d}});A.history.defaults.emot=true;E.add("history","emot",{render:function(a,b){b.msg.body=A.emot.parse(b.msg.body)}});X("emot",{template:'<div class="webim-emot ui-widget-content"><%=emots%></div>'},{_init:function(){var a=this,b=a.element;i(b.firstChild.childNodes,
...
this.li[a])&&a.firstChild.click();return a},hideError:function(){z(this.$.error)},showError:function(a){var b=this.$.error;b.innerHTML=x(a);H(b)},destroy:function(){}});ja("visitorstatus",{init:function(){var a=this.im,b=a.status,d=b.get("v_f"),g=b.get("v_l"),h=t.referrer,k=t.location.href,m=t.location.host;if(h&&h!=d){var n=(ex=/\/\/([^\/]+)/.exec(h))&&ex[1];if(n&&n!=m)b.set("v_f",h);else h=d}else h=d;k!=g&&b.set("v_l",k);this.visitorstatus=k+(h?" | "+x("from")+" "+h:"");var p={};a.bind("sendMsg",
function(q){var B="v_to_"+q.to;if(!p[B]){p[B]=true;var N="",O=a.status.get(B);if(!O||k!=g||h!=d){a.status.set(B,1);N=x("location")+": "+k;if(h&&(!O||h!=d))N+=" \n "+x("from")+": "+h}N&&a.sendMsg(f({},q,{body:N,"transient":true}))}})},ready:function(a){a.visitorstatus=this.visitorstatus}});ja("logmsg",{init:function(){var a=this.im;a.connection.bind("data",function(b){b=b&&b.messages;for(var d=0;d<b.length;d++){var g=b[d];g.ticket=a.data.connection.ticket;a.request({type:"post",url:a.options.urls.logmsg,
